...
import { ArrowRight, Grid, LayoutGrid, Search, X, ZoomIn, ChevronLeft, ChevronRight } from 'lucide-react';
import { galleryCategories, getAllImages, GalleryImage, GalleryCategory } from '@/data/galleryData';
    ...
    <div className="min-h-screen bg-gray-50" style={{ direction: 'rtl' }}>
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-4">معرض الأثاث الفاخر</h1>
